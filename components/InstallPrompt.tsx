...
const InstallPrompt: React.FC<InstallPromptProps> = ({ onInstall, onDismiss, lang }) => {
  return (
    <div className="fixed bottom-24 left-4 right-4 md:left-auto md:right-4 md:w-96 bg-white dark:bg-slate-800 rounded-xl shadow-2xl border border-slate-200 dark:border-slate-700 p-4 z-50 animate-slide-up">
      ...
      <div className="flex space-x-3">
        ...
        <button 
          onClick={onInstall}
          className="flex-1 py-2 px-3 bg-orange-600 text-white text-sm font-bold rounded-lg hover:bg-orange-700 transition-colors shadow-md"
        >
